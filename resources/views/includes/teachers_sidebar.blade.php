    ...
    <aside class="brand-color text-white w-64 min-h-screen flex flex-col justify-between p-6">
        <div>
            ...
            <nav class="space-y-0 text-lg">
                <a href="{{ route('teacher.dashboard') }}" class="flex items-center  px-3 py-2 rounded-lg
                   hover:bg-blue-500/20 transition">📚 Assigned Courses</a>
                <a href="#" class="flex items-center  px-3 py-2 rounded-lg
                   hover:bg-blue-500/20 transition">👨‍🏫 My Profile</a> 
                <a href="{{ route('add.lessons') }}" class="flex items-center  px-3 py-2 rounded-lg
                   hover:bg-blue-500/20 transition">📜 lesson</a>
                <a href="{{ route('teacher.exam.name') }}" class="flex items-center  px-3 py-2 rounded-lg
                   hover:bg-blue-500/20 transition">📝 Exam</a>
                <a href="{{ route('teacher.answer.sheet') }}" class="flex items-center  px-3 py-2 rounded-lg
                   hover:bg-blue-500/20 transition">✅ Answer Sheet</a>
            </nav>
        </div>
        <div class="mt-auto">
